...
from .views import news_list,news_detail,HomePageView,ContactPageView,LocalNewsView,ForeignNewsView,SportNewsView,TechnologyNewsView,NewsDeleteView,NewsUpdateView,NewsCreateView,admin_page,SearchResultList
